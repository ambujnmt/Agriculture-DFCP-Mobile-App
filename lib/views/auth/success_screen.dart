          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                customText.kText(from == "registration" ? TextConstants.regSuccessMsg : TextConstants.passwordChangeDesc, 32, FontWeight.w700, ColorConstants.kSecondary, TextAlign.center),
                SizedBox(height: height * 0.15),
                CustomButton(

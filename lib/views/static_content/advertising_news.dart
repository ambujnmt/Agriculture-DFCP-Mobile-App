...
class AdvertisingNews extends StatefulWidget {
  const AdvertisingNews({super.key});

  @override
  State<AdvertisingNews> createState() => _AdvertisingNewsState();
}

class _AdvertisingNewsState extends State<AdvertisingNews> {
          ...
          Positioned(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  customText.kText(
                    TextConstants.advertiseAndNews,
                    22,
                    FontWeight.w700,
                    ColorConstants.kTextGreen,
                    TextAlign.start,

...
class StudentAddUpdate extends StatefulWidget {
  const StudentAddUpdate({super.key});

  @override
  State<StudentAddUpdate> createState() => _StudentAddUpdateState();
}
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  customText.kText(TextConstants.addStudent, 32, FontWeight.w700, ColorConstants.kSecondary, TextAlign.center),

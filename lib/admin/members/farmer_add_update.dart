...
class FarmerAddUpdate extends StatefulWidget {
  const FarmerAddUpdate({super.key});

  @override
  State<FarmerAddUpdate> createState() => _FarmerAddUpdateState();
}

class _FarmerAddUpdateState extends State<FarmerAddUpdate> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  customText.kText(TextConstants.addFarmer, 32, FontWeight.w700, ColorConstants.kSecondary, TextAlign.center),

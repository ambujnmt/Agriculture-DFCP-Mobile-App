...
class AdvisorAddUpdate extends StatefulWidget {
  const AdvisorAddUpdate({super.key});

  @override
  State<AdvisorAddUpdate> createState() => _AdvisorAddUpdateState();
}

class _AdvisorAddUpdateState extends State<AdvisorAddUpdate> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  customText.kText(TextConstants.addAdvisor, 32, FontWeight.w700, ColorConstants.kSecondary, TextAlign.center),
